...
- 5 枚 `1142009-1142013` 是**职业专属**（战武神/圣贤者/狙击王/影飞侠/海盗王，reqJob=1/2/4/8/16，lv180）：仅当 bot 基数职业匹配时可选。**注**：海盗系 bot 现已支持（`rollBaseClass` 会掷出 base class 5，`BotMedalPool.baseClassBit` 对 5xx 返回 16），故 reqJob=16 的海盗王勋章对海盗系 bot 可选，不再是死条目。

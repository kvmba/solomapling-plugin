        ...
        switch (input.toLowerCase()) {
            ...
            case "mount": {
                ...
                soloMapling.ArtificialPlayer.BotSM bot =
                        soloMapling.ArtificialPlayer.BotMessagingSystem.CharacterStorage.getBotById(fakechar.getId());
...
//                break;
    ...
    private static void handleSpawn(String[] params, boolean autoAttack, Client c) {
        ...
        for (int i = 0; i < count; i++) {
            int botId = BotGeneration.createBot(pos, map, baseClass, band[0], band[1], 0);
            if (botId <= 0) {

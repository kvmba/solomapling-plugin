...
public enum SocialIntent {
    ...
    PRAISE("Praise",
            ...
            new String[]{"厉害", "牛逼", "牛批", "牛啊", "太牛", "真牛", "大佬", "大神", "高手",
                    "太秀", "天秀", "秀儿", "太强", "好强", "真强", "很强", "强无敌", "无敌",
                    "膜拜", "跪了", "人形外挂", "战神"}),
    CHEER("Cheer",
            new String[]{"gkd"},
            new String[]{"加油", "冲冲冲", "冲鸭", "你可以的", "别放弃", "稳住", "干巴爹", "上分",
                    "拿捏", "练起来", "卷起来"}),
    PROVOKE("TeaseBack",
            new String[]{},
            new String[]{"就这", "菜鸡", "太菜", "好菜", "菜鸟", "菜爆", "垃圾", "废物", "弱爆",
                    "好弱", "太弱", "很弱", "离谱", "绝了", "服了", "无语", "摆烂", "拉胯", "刮痧",
                    "别玩了", "别练了", "别丢人", "你行你上", "丢人", "给我整笑", "笑不活了",
                    "急了", "破防", "绷不住", "栓q", "呵呵"}),
    WOW("Wow",
            new String[]{"awsl"},
            new String[]{"卧槽", "我擦", "我靠", "哇塞", "哇哦", "我的天", "天啊", "妈呀", "好家伙",
                    "我去", "芜湖", "爷青回", "泪目", "震撼", "起飞"}),
    LAUGH("Laugh",
            new String[]{"233", "2333", "hhh", "hhhh", "xswl"},
            new String[]{"哈哈", "笑死", "笑飞", "笑麻", "乐死", "逗死", "嘿嘿", "嘻嘻", "噗嗤",
                    "绷不住了"}),
    AGREE("Agree",
            new String[]{"+1", "u1s1"},
            new String[]{"嗯嗯", "哦哦", "对对", "确实", "有道理", "说得对", "说得是", "没错",
                    "没毛病", "加一", "附议", "同感", "是这样的", "就是这样"});
